...
import image_segment.networks as networks
import image_segment.losses as losses
import image_segment.cluster as cluster
...
class NetworkWrapper(ABC):
    ...
    def load(self, filename):
        ...
        print("filename : ",filename[:-3]+"pt")
        #torch.save(self.model.state_dict(), filename[:-3]+"pt")
        #print("SHOULD HAVE SAVED : ",filename[:-3]+"pt")
